...
('V101', 'Carlos', 'Gomez', '1985-05-10', 'M'),
('V102', 'Ana', 'Perez', '1990-02-15', 'F'),
('V103', 'Luis', 'Martinez', '1988-11-20', 'M'), 
('V104', 'Laura', 'Lopez', '1995-03-25', 'F'),
('V105', 'Pedro', 'Rojas', '1982-01-01', 'M'),
('V201', 'Juan', 'Castro', '2000-01-20', 'M'),
('V202', 'Elena', 'Silva', '1995-06-18', 'F'),
('V203', 'Ricardo', 'Paez', '1978-04-11', 'M');

-- Hospitales y Departamentos
INSERT INTO Hospital (nombre, ciudad_hos) VALUES 
('Hospital Metropolitano', 'Caracas'), 
('Centro Médico Valencia', 'Valencia');
INSERT INTO Departamento (id_hospital, nombre, tipo) VALUES
(1, 'Cardiología', 'medico'),
(1, 'Administración', 'administrativo'), 
(1, 'Emergencia', 'medico'),
(2, 'Traumatología', 'medico'), 
(2, 'Gestión de Pacientes', 'administrativo');
...
INSERT INTO Personal (ci, annios_serv) VALUES ('V101', 14),
('V102', 12),
('V103', 9), 
('V104', 4),
('V105', 6);
...
-- Pacientes y Seguros
INSERT INTO Paciente (ci, edad, requiere_resp, telefono) VALUES
('V201', 24, FALSE, '0412-111'),
('V202', 29, FALSE, '0414-222'), 
('V203', 46, FALSE, '0416-333');
INSERT INTO Compania_Aseguradora (nombre_aseguradora, telefono) VALUES 
('Seguros Horizonte', '0212-999');
...
INSERT INTO Procedimiento (nombre, precio) VALUES 
('Consulta Cardiológica', 100),
('Consulta General', 80), 
('Operación de Rodilla', 3000),
('Radiografía', 80);
INSERT INTO Consulta (hora, fecha, ci_medico, ci_paciente, id_procedimiento) VALUES
('09:00', '2023-10-10', 'V101', 'V201', 1), 
('10:00', '2023-10-11', 'V101', 'V202', 1),
('11:00', '2023-10-12', 'V101', 'V203', 1),
('14:00', '2023-11-15', 'V105', 'V201', 2),
('15:00', '2023-11-16', 'V105', 'V202', 2), 
('12:00', '2023-11-18', 'V201', 'V202', 2);
INSERT INTO Habitacion (num_habitacion, id_hospital, id_departamento, num_camas, tarifa, tipo) VALUES
(301, 2, 4, 1, 200, 'individual');
...
(1, 'V201', 'V103'), (2, 'V202', 'V104');

-- Proveedores, Insumos, Encargos y Necesitan
INSERT INTO Proveedor (nombre_compania, ciudad_prov) VALUES 
('Farmatodo', 'Caracas'), 
('Equipos Medicos VZLA', 'Valencia');
INSERT INTO Insumo_Medico (nombre, tipo_insumo, stock, precio) VALUES 
('Bisturí', 'Instrumental', 0, 15),
('Guantes', 'Suministro', 0, 0.5);
